...
const SidebarComponent: React.FC<SidebarComponentProps> = ({onMenuSelect, onSidebarCollapse, selectedKey}) => {
    const [collapsed, setCollapsed] = useState(false);
    const [servicesStatus, setServicesStatus] = useState<ServiceStatusType>({data: []});
